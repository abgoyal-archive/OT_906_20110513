...
/**
*   @defgroup   I2SDAIGroup   I2S DAI API
*   @brief      This group defines the I2S DAI API
*
*****************************************************************************/
...
void release_i2s_device(struct i2s_device *i2s_handle)
{
	...
	spin_unlock_irqrestore(&bcm_i2s.i2s_lock, flags);
	/*Write reset values */
	set_register(REG_DATXCTRL_RESET_VAL, I2S_DATXCTRL_REG);
	set_register(REG_DARXCTRL_RESET_VAL, I2S_DARXCTRL_REG);
	set_register(REG_RESET_VAL, I2S_DAI2SRX_REG);
	set_register(REG_RESET_VAL, I2S_DADMACTRL_REG);
	set_register(REG_RESET_VAL, I2S_DASTA_REG);
	pr_debug("[bcm_i2s] %s: released i2s handle \r\n", __FUNCTION__);
}


/**
* @brief	Configure Playback/Record Interrupts and enable TX/Rx FIFO 
*
...
/**
* @brief 	Read the status of Interrupts
*
* @param handle 	i2S device Instance 
* @param direction	Direction (Playback/Capture)
*	
...
/**
* @brief 	Enable Interrupts when TX/Rx FIFO is empty
*
* @param handle		i2S device Instance
* @param direction	Direction (Playback/Capture) 
* @param en_dis		Enable/Disable the FIFO
...
/**
* @brief	Enable Transmit/Receive (TX/Rx) FIFO 
*
* @param handle		i2S device Instance
* @param direction	Direction (Playback/Capture)
*
...
/**
* @brief 	Disable Transmit/Receive (TX/Rx) FIFO
*
* @param handle		i2S device Instance
* @param direction	Direction(Playback/Capture)
*
...
/**
* @brief 	Flush Transmit/Receive (TX/Rx) FIFO
*
* @param handle		i2S device Instance		
* @param direction	Direction(Playback/Capture)
*
...
/**
* @brief 	Configure Sample Rate Divider ratio
*
* @param handle		i2S device Instance
...
/**
* @brief 	Configure Master/Slave mode for playback
*
* @param handle			i2S device Instance
...
/**
* @brief 	Enable I2S TX/RX interface for transmission or receive
*
* @param handle		i2S device Instance
...
/**
* @brief 	Disable transmission/receive on I2S interface
*
* @param handle		i2S device Instance
...
/**
* @brief 	Enable/Disable Loopback mode of I2S. Used only for debugging
*
* @param handle		i2S device Instance
...
/**
* @brief 	Configure Mono Record Mode
*
* @param handle		i2S device Instance
...
/**
* @brief 	Get current status of the DAI
*
* @param handle		i2S device Instance
*
* @return 			0 on success; -EINVAL on FAILURE 
...
/**
* @brief 	Issue Soft Reset to I2S DAI
*
* @param handle	 i2S device Instance
*/
...
/**
* @brief 	Enable Internal/External clock for I2S module
*
* @param handle		i2S device Instance
...
/**
* @brief 	 Disable Internal/External clock for I2S module
*
* @param handle	i2S device Instance
* @param clk	Internal/External Clock
*
...
#if (!cpu_is_bcm2153())
/**
* @brief 	Configure pad DAOLR when it's not in use
*
* @param handle	 	i2S device Instance
...
/**
* @brief 	Configure pad DAILR when it's not in use	
*
* @param handle		i2S device Instance
...
/**
* @brief 		configure Tx/Rx channel size 
*
* @param handle	 	i2S device Instance
* @param direction	Direction(Playback/Capture)
...
/**
* @brief 	Configure Audio Data Depth
*
* @param handle		i2S device Instance
* @param direction	Direction(Playback/Capture)
...
/**
* @brief 	Configure the Audio Data Depth Value
*
* @param handle			i2S device Instance
* @param direction		Direction(Playback/Capture)
...
/**
* @brief 	Enable MSB alignment of TX/RX FIFO data 
*
* @param handle		i2S device Instance
* @param direction	Direction(Playback/Capture)
*
...
/**
* @brief 	Disable MSB alignment of TX/RX FIFO data
*
* @param handle		i2S device Instance
* @param direction	Direction(Playback/Capture)
*
...
/**
* @brief 	Configure Justified I2S mode
*
* @param handle		i2S device Instance
* @param direction	Direction(Playback/Capture)
*
...
/**
* @brief 	Configure normal I2S mode
*
* @param handle		i2S device Instance
* @param direction	Direction(Playback/Capture)
*
...
/**
* @brief 	Configure Audio SCLK STOP Register
*
* @param handle			i2S device Instance
...
/**
* @brief 	Set SPDIF mode PREAMBLE MAP	
*
* @param handle		i2S device Instance
