...
*
* 	@file	drivers/input/misc/akm8973.c
*
...
static int akm8973_convert_adc_offset(u8 offset, u8 value)
{
	...
	return ((offset * 15625) - 1984375) + ((value - 128) * 1000);
}
...
static void akm8973_report_values(struct akm8973_data *akm, int *values)
{
...
static int akm8973_input_init(struct akm8973_data *akm)
{
	...
	input_set_abs_params(akm->input_dev, ABS_HAT0X, -2000, 2000, FUZZ,
			     FLAT);
	/* y-axis of raw magnetic vector */
	input_set_abs_params(akm->input_dev, ABS_HAT0Y, -2000, 2000, FUZZ,
			     FLAT);
	/* z-axis of raw magnetic vector */
	input_set_abs_params(akm->input_dev, ABS_BRAKE, -2000, 2000, FUZZ,
			     FLAT);
	/* temperature */
	input_set_abs_params(akm->input_dev, ABS_THROTTLE, -30, 85, FUZZ, FLAT);

	akm->input_dev->name = "akm8973";
