...
enum {
	...
	/*used to convert adc value read using adc_access function to 8-bit adc
	 Power driver uses CP interface to get bat adc value. This event is ONLY used to just
	 initilize capacity value during init (RIL interface may not be ready duirng power driver init)
	 Later battery capacity is calculated again based on the 8-bit adc value recevied from CP
	 */
	PMU_EVENT_BATT_ADC_TO_8BIT_ADC,
...
typedef enum
{
	BCM59035_CHARGING_TIME_3HRS,
	BCM59035_CHARGING_TIME_4HRS,
	BCM59035_CHARGING_TIME_5HRS,
	BCM59035_CHARGING_TIME_6HRS,
	BCM59035_CHARGING_TIME_7HRS,
	BCM59035_CHARGING_TIME_8HRS,
	BCM59035_CHARGING_TIME_9HRS,
	BCM59035_CHARGING_TIME_DISABLE
}bcm59035_charging_timeout;
...
struct charger_info {
	...
	bcm59035_charging_timeout max_charging_time; /**<max charging time - battery is assumed dead
						if the battery does not get charged within the specified time*/
...
struct bcm59035_power_pdata {
	...
	can be measured*/
	int batt_vol_adc_channel; /**< ADC channel on read battery voltage. USED
	DURING INIT ONLY
	*/
