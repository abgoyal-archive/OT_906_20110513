...
/* Charging current MBCCTRL4[3:0] */
enum {
	MAX8986_CHARGING_CURR_200MA = 0,
	...
	MAX8986_CHARGING_CURR_90MA,	/* Just to indicate charging current */
...
enum {
	MAX8986_CHARGER_NONE = 0,	/* nothing attached */
	MAX8986_CHARGER_USB,		/* USB Cable attached */
	MAX8986_CHARGER_CDP,		/* Charging Downstream port */
	MAX8986_CHARGER_DEDICATED,	/* dedicated chgr:current upto 1.8A */
	MAX8986_CHARGER_SPECIAL1,	/* Special 500mA chgr:Current 500mA */
	MAX8986_CHARGER_SPECIAL2,	/* Special 1A chgr: Current up to 1A */
	MAX8986_CHARGER_RESERVED,	/* Reserved for Future Use */
	MAX8986_CHARGER_DEAD_BATT,	/* Dead Battery Charging 100mA max */
	MAX8986_CHARGER_INVALID
};
...
/* MBCCTRL1 */
#define MAX8986_MBCCTRL1_TFCH_MASK	((0x07 << 4)|(0x04))
/* Fast charge timer setting for fast charging process MBCCTRL1[6:4] */
#define MAX8986_MBCCTRL1_TFCH_5HR	((0x02 << 4)|(0x04))
#define MAX8986_MBCCTRL1_TFCH_6HR	((0x03 << 4)|(0x04))
#define MAX8986_MBCCTRL1_TFCH_7HR	((0x04 << 4)|(0x04))
...
/* MBCCTRL4 */
#define MAX8986_MBCCTRL4_MBCICHFC_MASK	0x0F
...
#define MAX8986_ENV1_BBLOW		(0x01 << 6)
...
/* Exit Dead Battery Charge Mode */
#define MAX8986_M_CDETCTRL0_DBEXIT	(0x01 << 5)
#define MAX8986_M_CDETCTRL0_DBIDLE	(0x01 << 6)/* Dead Battery Mode Idle */
...
#define MAX8986_M_CONTROL1_MICEN	(0x01 << 6)
...
#define MAX8986_NUM_MUIC_INT_REG_START	0x03
...
extern int max8986_request_irq(struct max8986 *max8986, int irq,
	bool enable_irq, void (*handler) (int, void *), void *data);
extern int max8986_register_ioctl_handler(struct max8986 *max8986,
	u8 sub_dev_id, pmu_subdev_ioctl_handler handler, void *pri_data);

/* usb functions exported by android gadget */
