...
/**
	@brief  Set the debounce value for the specified GPIO number
...
/**
	@brief  Enable/Disable pull up's and pull down's for specified GPIO.
	@param	gpio (in) GPIO number
...
/**
	@brief  Set specified GPIO pull up or set specified GPIO pull down.
	@param	gpio (in) GPIO number
...
/**
	@brief  Get the direction(input/output) for the specified GPIO
	@param	gpio (in) GPIO number
...
/**
	@brief  Get specified GPIO IRQ type
	@param	gpio (in) GPIO number
...
/**
	@brief  Get the debounce value set for the specified GPIO value
	@param	gpio (in) GPIO number
