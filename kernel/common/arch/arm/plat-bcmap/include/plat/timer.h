...
/**
 * struct timer_config - timer configuration identifying the timer to use.
 * @cs_base:	The base address of clock source timer. This is the address of GPT base.
 * @ce_base:	The base address of clock event timer.
 * @cs_index:	The index of GPT to use as clock source.
 * @ce_index:	The index of the clock event timer to use.
 * @irq		The irq associated with clock event.
 */
struct timer_config {
