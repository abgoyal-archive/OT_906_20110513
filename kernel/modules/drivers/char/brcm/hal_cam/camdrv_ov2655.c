...
CamImageSize_t g_Current_PreviewSize = CamImageSize_QVGA;
...
static void    OV2650_SetPreviewZoom( CamZoom_t zoom_step)
{
	...
	switch(zoom_step)
	{
		case CamZoom_1_0:	// zoom X1
			...
			if(CamImageSize_QVGA == g_Current_PreviewSize)
			{
			...
			else if(CamImageSize_QCIF == g_Current_PreviewSize)
			{
...
static HAL_CAM_Result_en_t SensorSetPreviewMode(CamImageSize_t image_resolution, CamDataFmt_t image_format)
{
   ...
   // ov_write(0x3391, 0x06);
    ...
    ov_write(0x3373, 0x50);
    ov_write(0x3376, 0x06);//for preview sharp
    ...
    {	
        case CamImageSize_R_QCIF: //  R_QCIF			  144x176
        	g_Current_PreviewSize = CamImageSize_R_QCIF;
    		ov_write(0x3302,0x11);	
        ...
        case CamImageSize_R_QVGA: //  R_QVGA			  240x320
        	g_Current_PreviewSize = CamImageSize_R_QVGA;
    		ov_write(0x3302,0x11);	
        ...
        case CamImageSize_QCIF: //  QCIF			  176x144   
        	g_Current_PreviewSize = CamImageSize_QCIF;
            ov_write(0x3302,0x11);	
            ov_write(0x3088,0x00);
            ov_write(0x3089,0xb0);
            ov_write(0x308a,0x00);
        ...
        case CamImageSize_QVGA:	//	QVGA 			320x240  		
        	g_Current_PreviewSize = CamImageSize_QVGA;
            //320
            ov_write(0x3088,0x01);
            ov_write(0x3089,0x40);
            //240
        ...
        case CamImageSize_CIF: //  CIF		   352x288	
        	g_Current_PreviewSize = CamImageSize_CIF;
        ...
        case CamImageSize_VGA:	 //  VGA	   640x480 
        	g_Current_PreviewSize = CamImageSize_VGA;
            ov_write(0x3302,0x11);				   
        ...
        case CamImageSize_SVGA://  SVGA 		   800x600	
        	g_Current_PreviewSize = CamImageSize_SVGA;
            ov_write(0x300e,0x34);  
...
static HAL_CAM_Result_en_t Init_OV2655(CamSensorSelect_t sensor)
{
    ...
    ov_write(0x302b,0x6a);
   // ov_write(0x3391,0x06);
    ov_write(0x3394,0x34);
    ov_write(0x3395,0x34);
...
/////////////////////////////////////////////////////////////////////
    ...
    ov_write(0x3383,0x2d);  
    ov_write(0x3384,0xb8);
    ov_write(0x3385,0xe5);  
    ov_write(0x3386,0xb7);  
    ov_write(0x3387,0xaf);  
    ov_write(0x3388,0x08);  
    ov_write(0x3389,0x98);
    ov_write(0x338a,0x01);

    //Gamma
    ov_write(0x3340,0x04);  
    ov_write(0x3341,0x07);  	
    ov_write(0x3342,0x19);  
    ov_write(0x3343,0x34);
    ov_write(0x3344,0x4a);  
    ov_write(0x3345,0x5a);  
    ov_write(0x3346,0x67);  
    ov_write(0x3347,0x71);  
    ov_write(0x3348,0x7c);  
    ov_write(0x3349,0x8c);
    ov_write(0x334a,0x9b);
    ov_write(0x334b,0xa9);
    ov_write(0x334c,0xc0);
    ov_write(0x334d,0xd5);
    ...
    //Lens correction
    //R
    ov_write(0x3350,0x33);
    ov_write(0x3351,0x28);
    ov_write(0x3352,0x00);
    ov_write(0x3353,0x14); 	//R-Gain ;0x25
    ov_write(0x3354,0x00);
    ov_write(0x3355,0x85);
    //G
    ov_write(0x3356,0x35);
    ov_write(0x3357,0x28);
    ov_write(0x3358,0x00);
    ov_write(0x3359,0x13);
    ov_write(0x335a,0x00);
    ov_write(0x335b,0x85);
    //B
    ov_write(0x335c,0x34);
    ov_write(0x335d,0x28);
    ov_write(0x335e,0x00);
    ov_write(0x335f,0x13);
    ...
    ov_write(0x30aa,0x82);
    ov_write(0x30a8,0x54);
    ov_write(0x30a3,0x91);
    ov_write(0x30a1,0x41);
    ov_write(0x363b,0x01);
