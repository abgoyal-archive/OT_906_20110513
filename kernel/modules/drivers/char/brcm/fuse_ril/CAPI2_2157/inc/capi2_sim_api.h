...
typedef enum
{
	SKT_USIM,
	KT_USIM,
	SKT_USIM_UNREGISTERED,
	KT_USIM_UNREGISTERED,
	STD_USIM
} USIM_CARRIER_MODE_t;
...
/**
  Get USIM carrier mode commend and result
**/
typedef struct
{
   	USIM_CARRIER_MODE_t carrierMode;
}SIM_GET_CARRIER_MODE_RSP_t;
...
typedef enum
{
	...
	SIM_ARR_NOT_EXIST,      ///< EF-ARR does not exist & there is a file whose security attribute uses "8B" tag. 
							///< See section 13.4 of 3GPP 31.102. This error is sent for 3G USIM only. 
