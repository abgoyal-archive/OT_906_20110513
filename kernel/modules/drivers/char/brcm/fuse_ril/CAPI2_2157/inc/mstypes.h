...
typedef enum
{
    ...
    MS_LOCAL_CC_ELEM_MPTY_CALL_SUPPORTED,             ///< Multi-party Call supported
    MS_LOCAL_CC_ELEM_CALL_BARRING_SUPPORTED,          ///< Call Barring supported
    MS_LOCAL_CC_ELEM_AOC_SUPPORTED,                   ///< Advice of Charge supported
    MS_LOCAL_CC_ELEM_CUG_SUPPORTED,                   ///< Closed User Group supported
	MS_LOCAL_CC_ELEM_UMTS_WB_AMR,					///< Enable/disable WB AMR for 3G
    ...
    MS_LOCAL_SATK_ELEM_BIP_CTR,                     ///< Whether BRCM STK module handles BIP
	...
	MS_LOCAL_PHCTRL_ELEM_FAST_BAND_SELECT_DISABLE,	///< Disable fast band select during RAT/band switch
    ...
    MS_LOCAL_PHCTRL_ELEM_OPEN_NORMAL_MODE,          ///< Open/normal mode
	...
	MS_LOCAL_AT_ELEM_QOS_CTRL,					///< AT audio control setting  
...
typedef enum
{
	...
	CALLSTATUS_SYNC_IND 				///< 15, MO/MT Call, networks sends Sync Ind
										///< NOTE: This status is internal to CAPI only.
...
typedef enum {
    ...
    MNCAUSE_MS_ACCESS_CLASS_BARRED              = 0x121, ///< 289. MS Access Class Barred
...
/**
	This enum is used to indicate flow control--- status (on/off)
**/
typedef enum
{
	DATA_RESUME = 0,
...
{
    UAS_HSDPA_DISABLE,
    UAS_HSDPA_CATEGORY_1,
    UAS_HSDPA_CATEGORY_2,
    UAS_HSDPA_CATEGORY_3,
    UAS_HSDPA_CATEGORY_4,
    UAS_HSDPA_CATEGORY_5,
    UAS_HSDPA_CATEGORY_6,
    UAS_HSDPA_CATEGORY_7,
    UAS_HSDPA_CATEGORY_8,
    UAS_HSDPA_CATEGORY_9,
    UAS_HSDPA_CATEGORY_10,
    UAS_HSDPA_CATEGORY_11,
    UAS_HSDPA_CATEGORY_12
} UasHsdpaCat_t;
...
typedef struct
{
    ...
    Boolean hsdpaCat_updated;
    UasHsdpaCat_t hsdpaCategory;
...
/* MobC00061383/CSP204798 */
    ...
    /* MobC00124603, flow control, Tony, 09/18/10 */
    Boolean watermark_updated;        
    UInt8   high_wartermark;
    UInt8   low_watermark;
    /* MobC00124603, flow control, Tony, 09/18/10 */
