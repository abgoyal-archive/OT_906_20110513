...
typedef enum {	// explicitly enum for easier debugging
	...
	**/
	...
	For the payload contents see ::
	**/

	MSG_LSA_ID_IND				= MSG_GRP_NET+0x12,
	...
	**/
	...
	MSG_SIM_MUL_REC_DATA_RSP				= MSG_GRP_SIM+0x25,	///<Payload type {::SIM_MUL_REC_DATA_t}
	...
	**/
	...
	/** 
	This message contains the response for "USIM Carrier Mode" for KT and SKT. 
	For payload contents see :: SIM_GET_USIM_CARRIER_MODE_RSP_t
	**/
	MSG_SIM_GET_USIM_CARRIER_MODE_RSP	= MSG_GRP_SIM+0x70,	///<Payload type {::SIM_GET_USIM_CARRIER_MODE_RSP_t}
	...
	*/
	...
	MSG_SIM_FATAL_ERROR_IND				= MSG_GRP_SIM+0x83,	///<Payload type: SIM_FATAL_ERROR_t
    ...
    **/ 
	...
	MSG_SMS_SMMA_RETRY_REQ		= MSG_GRP_INT_SMS_SS+0x0C,
	...
	**/
	...
	// uplink flow control indication message
	MSG_FLOW_CONTROL_IND	= MSG_GRP_INT_DC+0x26, ///<Payload type {::FlowControlInd_t}
	...
	MSG_SIM_PROC_GET_USIM_CARRIER_MODE_REQ	= MSG_GRP_INT_SIM+0x54,	///<Payload type {::SIM_PROC_GET_USIM_CARRIER_MODE_REQ_t}	/* Request to get USIM carrier mode */
    ...
    **/
    ...
    MSG_STK_SEND_CC_SETUP_REQ       = MSG_GRP_INT_STK+0x81,	///<Payload type {::StkSendCCSetupReq_t}
	MSG_STK_SEND_CC_SS_REQ          = MSG_GRP_INT_STK+0x82,	///<Payload type {::StkSendCCSsReq_t} 
	MSG_STK_SEND_CC_USSD_REQ        = MSG_GRP_INT_STK+0x83,	///<Payload type {::StkSendCCUssdReq_t}
	MSG_STK_SEND_CC_SMS_REQ         = MSG_GRP_INT_STK+0x84,	///<Payload type {::StkSendCCSmsReq_t}
	MSG_STK_SEND_ENVELOPE_CMD_REQ   = MSG_GRP_INT_STK+0x85,	///<Payload type {::StkSendEnvelopCmdReq_t}
	MSG_STK_SEND_TERMINAL_RSP_REQ   = MSG_GRP_INT_STK+0x86,	///<Payload type {::StkSendTerminalRspReq_t}
	...
	**/
	...
	@n@b Payload: Boolean
	**/
	MSG_SATK_SENDDATASERVREQ_RSP						= MSG_GRP_CAPI2_STK+0x0A,	///<Payload type {::Boolean}
...
//	MSG_CC_SETCALLNUMBER_REQ							= MSG_GRP_CAPI2_CC_REQ+0x22,	
    ...
    MSG_SATK_SENDDATASERVREQ_REQ		    			= MSG_GRP_CAPI2_INT_STK+0x10,
...
//	MSG_PDP_ACTIVATE_SNDCP_RSP							= MSG_GRP_CAPI2_PCH+0x2A,
	...
	MSG_PDP_GETUMTSMINQOS_REQ							= MSG_GRP_CAPI2_PCH+0x84,
	MSG_PDP_GETUMTSMINQOS_RSP							= MSG_GRP_CAPI2_PCH+0x85,	///<Payload type {::PCHUMTSQosProfile_t}
	MSG_PDP_GETUMTSQOS_REQ								= MSG_GRP_CAPI2_PCH+0x86,
	MSG_PDP_GETUMTSQOS_RSP								= MSG_GRP_CAPI2_PCH+0x87,	///<Payload type {::PCHUMTSQosProfile_t}
	MSG_PDP_SETUMTSMINQOS_REQ							= MSG_GRP_CAPI2_PCH+0x89,
	MSG_PDP_SETUMTSMINQOS_RSP							= MSG_GRP_CAPI2_PCH+0x8A,
	MSG_PDP_SETUMTSQOS_REQ								= MSG_GRP_CAPI2_PCH+0x8B,
	MSG_PDP_SETUMTSQOS_RSP								= MSG_GRP_CAPI2_PCH+0x8C,
