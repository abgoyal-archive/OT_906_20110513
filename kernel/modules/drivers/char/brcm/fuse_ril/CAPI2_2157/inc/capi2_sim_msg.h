...
XDR_STRUCT_DECLARE(SIM_MUL_REC_DATA_t)
...
XDR_STRUCT_DECLARE(CAPI2_SimMulRecordReq_t)
...
bool_t xdr_SIM_GET_CARRIER_MODE_RSP_t(XDR* xdrs, SIM_GET_CARRIER_MODE_RSP_t* info);
