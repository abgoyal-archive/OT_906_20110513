...
/* STK related CAPI2 message paylodads */
        ...
        CAPI2_StkDataServReq_t						CAPI2_SATKSendDataServReq_Req;		/* MSG_SATK_SENDDATASERVREQ_REQ */
		Boolean										CAPI2_SATKSendDataServReq_Rsp;		/* MSG_SATK_SENDDATASERVREQ_RSP */
...
/* SS related CAPI2 message paylodads */
		...
		CAPI2_PDP_ContextID_t 					CAPI2_PDP_GetUMTSMinQoS_Req;				/* MSG_PDP_GETUMTSMINQOS_REQ */ 
		PCHUMTSQosProfile_t 					PDP_GetUMTSMinQoS_Rsp;				/* MSG_PDP_GETUMTSMINQOS_RSP */ 
		CAPI2_PDP_ContextID_t 					CAPI2_PDP_GetUMTSQoS_Req;				/* MSG_PDP_GETUMTSQOS_REQ */ 
		PCHUMTSQosProfile_t 					PDP_GetUMTSQoS_Rsp;				/* MSG_PDP_GETUMTSQOS_RSP */ 
		...
		CAPI2_PDP_SetUMTSQoS_t 					CAPI2_PDP_SetUMTSMinQoS_Req;				/* MSG_PDP_SETUMTSMINQOS_REQ */ 
		CAPI2_PDP_SetUMTSQoS_t 					CAPI2_PDP_SetUMTSQoS_Req;				/* MSG_PDP_SETUMTSQOS_REQ */ 
		...
		CAPI2_SimMulRecordReq_t						sim_mul_record_req;
