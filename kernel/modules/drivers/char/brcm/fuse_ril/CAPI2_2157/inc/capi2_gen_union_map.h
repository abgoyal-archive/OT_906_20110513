...
#define _D(a) a
	...
	{ _D(MSG_MS_CELL_LOCK_REQ),_T("MSG_MS_CELL_LOCK_REQ"), (xdrproc_t) xdr_CAPI2_SYS_CellLock_Req_t, REQRSP_MSG_EXT(0, NULL, NULL, 0 )},
	{ _D(MSG_MS_CELL_LOCK_RSP),_T("MSG_MS_CELL_LOCK_RSP"), (xdrproc_t) xdr_default_proc, REQRSP_MSG_EXT(0, NULL, NULL, 0 )},
	...
	{ _D(MSG_SIM_MUL_REC_DATA_REQ),_T("MSG_SIM_MUL_REC_DATA_REQ"), (xdrproc_t) xdr_CAPI2_SimMulRecordReq_t,REQRSP_MSG_EXT(0, NULL, NULL, 65000 )},
	{ _D(MSG_SIM_MUL_REC_DATA_RSP),_T("MSG_SIM_MUL_REC_DATA_RSP"), (xdrproc_t)xdr_CAPI2_SIM_SubmitMulRecordEFileReq_Rsp_t, REQRSP_MSG_EXT( sizeof( SIM_MUL_REC_DATA_t ), NULL, NULL, 65000 )},
	...
	{ _D(MSG_SYSPARAM_GET_IMEI_REQ),_T("MSG_SYSPARAM_GET_IMEI_REQ"), (xdrproc_t) xdr_CAPI2_SYSPARM_GetImei_Req_t, REQRSP_MSG_EXT(0, NULL, NULL, 0 )},
	...
	{ _D(MSG_SIM_GET_USIM_CARRIER_MODE_REQ),_T("MSG_SIM_GET_USIM_CARRIER_MODE_REQ"), (xdrproc_t) xdr_default_proc, REQRSP_MSG_EXT(0, NULL, NULL, 0 )},
	{ _D(MSG_SIM_GET_USIM_CARRIER_MODE_RSP),_T("MSG_SIM_GET_USIM_CARRIER_MODE_RSP"), (xdrproc_t)xdr_CAPI2_SIM_GetUsimCarrierMode_Rsp_t, REQRSP_MSG_EXT( sizeof( SIM_GET_CARRIER_MODE_RSP_t ), NULL, NULL, 0 )},
	...
	{ _D(MSG_AUDIO_DRV_SetAudioMode_REQ),_T("MSG_AUDIO_DRV_SetAudioMode_REQ"), (xdrproc_t) xdr_CAPI2_AUDIO_DRV_SetAudioMode_Req_t, REQRSP_MSG_EXT(0, NULL, NULL, 0 )},
	{ _D(MSG_AUDIO_DRV_SetAudioMode_RSP),_T("MSG_AUDIO_DRV_SetAudioMode_RSP"), (xdrproc_t) xdr_default_proc, REQRSP_MSG_EXT(0, NULL, NULL, 0 )},
	...
	{ _D(MSG_AUDIO_GET_SETTINGSEX_REQ),_T("MSG_AUDIO_GET_SETTINGSEX_REQ"), (xdrproc_t) xdr_CAPI2_AUDIO_GetSettingsEx_Req_t, REQRSP_MSG_EXT(0, NULL, NULL, 0 )},
	{ _D(MSG_AUDIO_GET_SETTINGSEX_RSP),_T("MSG_AUDIO_GET_SETTINGSEX_RSP"), (xdrproc_t)xdr_CAPI2_AUDIO_GetSettingsEx_Rsp_t, REQRSP_MSG_EXT( sizeof( Capi2AudioParams_t ), NULL, NULL, 0 )},
	...
	{ _D(MSG_LSA_ID_IND),_T("MSG_LSA_ID_IND"), (xdrproc_t)xdr_CAPI2_MS_LsaIdInd_Rsp_t, REQRSP_MSG_EXT( sizeof( lsaIdentity_t ), NULL, NULL, 0 )},
	{ _D(MSG_SIM_ISTESTSIM_REQ),_T("MSG_SIM_ISTESTSIM_REQ"), (xdrproc_t) xdr_default_proc, REQRSP_MSG_EXT(0, NULL, NULL, 0 )},
	{ _D(MSG_SIM_ISTESTSIM_RSP),_T("MSG_SIM_ISTESTSIM_RSP"), (xdrproc_t)xdr_CAPI2_SIM_IsTestSIM_Rsp_t, REQRSP_MSG_EXT( sizeof( Boolean ), NULL, NULL, 0 )},
	{ _D(MSG_MS_OEM_SET_DATA_REQ),_T("MSG_MS_OEM_SET_DATA_REQ"), (xdrproc_t) xdr_CAPI2_OEM_Set_Data_Req_t, REQRSP_MSG_EXT(0, NULL, NULL, 0 )},
	{ _D(MSG_MS_OEM_SET_DATA_RSP),_T("MSG_MS_OEM_SET_DATA_RSP"), (xdrproc_t)xdr_CAPI2_OEM_Set_Data_Rsp_t, REQRSP_MSG_EXT( sizeof( UInt32 ), NULL, NULL, 0 )},
	{ _D(MSG_MS_OEM_GET_DATA_REQ),_T("MSG_MS_OEM_GET_DATA_REQ"), (xdrproc_t) xdr_CAPI2_OEM_Get_Data_Req_t, REQRSP_MSG_EXT(0, NULL, NULL, 0 )},
	{ _D(MSG_MS_OEM_GET_DATA_RSP),_T("MSG_MS_OEM_GET_DATA_RSP"), (xdrproc_t)xdr_CAPI2_OEM_Get_Data_Rsp_t, REQRSP_MSG_EXT( sizeof( CAPI2_Oem_Payload_t ), NULL, NULL, 0 )},
	{ _D(MSG_WL_PS_SET_FILTER_LIST_REQ),_T("MSG_WL_PS_SET_FILTER_LIST_REQ"), (xdrproc_t) xdr_CAPI2_WL_PsSetFilterList_Req_t, REQRSP_MSG_EXT(0, NULL, NULL, 0 )},
	{ _D(MSG_WL_PS_SET_FILTER_LIST_RSP),_T("MSG_WL_PS_SET_FILTER_LIST_RSP"), (xdrproc_t) xdr_default_proc, REQRSP_MSG_EXT(0, NULL, NULL, 0 )},
	...
	CAPI2_SYS_CellLock_Req_t   CAPI2_SYS_CellLock_Req;
	...
	CAPI2_SIM_SubmitMulRecordEFileReq_Rsp_t   CAPI2_SIM_SubmitMulRecordEFileReq_Rsp;
	...
	CAPI2_SYSPARM_GetImei_Req_t   CAPI2_SYSPARM_GetImei_Req;
	...
	CAPI2_SIM_GetUsimCarrierMode_Rsp_t   CAPI2_SIM_GetUsimCarrierMode_Rsp;
	...
	CAPI2_AUDIO_DRV_SetAudioMode_Req_t   CAPI2_AUDIO_DRV_SetAudioMode_Req;
	...
	CAPI2_AUDIO_GetSettingsEx_Req_t   CAPI2_AUDIO_GetSettingsEx_Req;
	CAPI2_AUDIO_GetSettingsEx_Rsp_t   CAPI2_AUDIO_GetSettingsEx_Rsp;
	...
	CAPI2_MS_LsaIdInd_Rsp_t   CAPI2_MS_LsaIdInd_Rsp;
	CAPI2_SIM_IsTestSIM_Rsp_t   CAPI2_SIM_IsTestSIM_Rsp;
	CAPI2_OEM_Set_Data_Req_t   CAPI2_OEM_Set_Data_Req;
	CAPI2_OEM_Set_Data_Rsp_t   CAPI2_OEM_Set_Data_Rsp;
	CAPI2_OEM_Get_Data_Req_t   CAPI2_OEM_Get_Data_Req;
	CAPI2_OEM_Get_Data_Rsp_t   CAPI2_OEM_Get_Data_Rsp;
