...
}CAPI2_MS_ConvertPLMNNameStr_t;


XDR_STRUCT_DECLARE(WL_SocketFilterList_t)

XDR_ENUM_DECLARE(PowerOnCause_t)
...
XDR_STRUCT_DECLARE(ADC_StartRsp_t)
XDR_STRUCT_DECLARE(Capi2GpioValue_t)
XDR_STRUCT_DECLARE(CAPI2_ADC_ChannelReq_t)
XDR_STRUCT_DECLARE(CAPI2_ADC_ChannelRsp_t)
XDR_STRUCT_DECLARE(InterTaskMsg_t)
XDR_STRUCT_DECLARE(CAPI2_Oem_Payload_t)

XDR_STRUCT_DECLARE(Batt_Level_Table_t)

XDR_ENUM_DECLARE(RegisterStatus_t)
XDR_ENUM_DECLARE(PCHRejectCause_t)
XDR_ENUM_DECLARE(TimeZoneUpdateMode_t)

XDR_ENUM_DECLARE(HAL_EM_BATTMGR_Result_en_t)
XDR_ENUM_DECLARE(HAL_EM_BatteryLevel_t)
XDR_ENUM_DECLARE(HAL_EM_BATTMGR_Event_en_t)
XDR_ENUM_DECLARE(HAL_EM_BATTMGR_Charger_t)
XDR_ENUM_DECLARE(HAL_EM_BATTMGR_Charger_InOut_t)

XDR_ENUM_DECLARE(MS_Element_t)

XDR_ENUM_DECLARE(SpeakerTone_t)
XDR_ENUM_DECLARE(AudioMode_t)
