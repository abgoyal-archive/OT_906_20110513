...
}CAPI2_SIM_SubmitMulRecordEFileReq_Rsp_t;
...
typedef struct
{
	IMEI_TYPE_t  imei_type;
}CAPI2_SYSPARM_GetImei_Req_t;
...
typedef struct
{
	SIM_GET_CARRIER_MODE_RSP_t	*val;
}CAPI2_SIM_GetUsimCarrierMode_Rsp_t;
...
typedef struct
{
	AudioMode_t  mode;
	UInt8  op;
}CAPI2_AUDIO_DRV_SetAudioMode_Req_t;
...
typedef struct
{
	UInt8  audioMode;
	UInt8  audioOp;
}CAPI2_AUDIO_GetSettingsEx_Req_t;

typedef struct
{
	Capi2AudioParams_t	val;
}CAPI2_AUDIO_GetSettingsEx_Rsp_t;
...
{
	lsaIdentity_t	*val;
}CAPI2_MS_LsaIdInd_Rsp_t;

typedef struct
{
	Boolean	val;
}CAPI2_SIM_IsTestSIM_Rsp_t;

typedef struct
{
	UInt32  type;
	CAPI2_Oem_Payload_t  *payload;
}CAPI2_OEM_Set_Data_Req_t;

typedef struct
{
	UInt32	val;
}CAPI2_OEM_Set_Data_Rsp_t;

typedef struct
{
	UInt32  type;
}CAPI2_OEM_Get_Data_Req_t;

typedef struct
{
	CAPI2_Oem_Payload_t	val;
}CAPI2_OEM_Get_Data_Rsp_t;
