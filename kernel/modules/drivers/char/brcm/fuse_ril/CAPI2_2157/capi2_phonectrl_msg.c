...
xdr_nitzNetworkName_t( XDR* xdrs, nitzNetworkName_t* data)
{
	...
	if(	_xdr_Boolean(xdrs, &data->fromGmmInfo, "fromGmmInfo") &&
		xdr_opaque(xdrs, (caddr_t)&data->longName, 255) &&
...
xdr_TimeZoneDate_t( XDR* xdrs, TimeZoneDate_t* data)
{
	...
	if(	_xdr_Boolean(xdrs, &data->fromGmmInfo, "fromGmmInfo")  &&
		xdr_char(xdrs, (char*)&data->timeZone)	&&
...
//		{ (int)MS_LOCAL_CC_ELEM_CLIR,_T("MS_LOCAL_CC_ELEM_CLIR"),								(xdrproc_t)XDR_ENUM_DEF(CLIRMode_t), sizeof( UInt8 ), NULL_capi2_proc_t, (xdrproc_t)XDR_ENUM_DEF(CLIRMode_t),0 },
        { (int) MS_LOCAL_CC_ELEM_MPTY_CALL_SUPPORTED,_T("MS_LOCAL_CC_ELEM_MPTY_CALL_SUPPORTED"),	(xdrproc_t)xdr_u_char, sizeof( UInt8 ), NULL_capi2_proc_t, (xdrproc_t)xdr_u_char,0  },
        { (int) MS_LOCAL_CC_ELEM_CALL_BARRING_SUPPORTED,_T("MS_LOCAL_CC_ELEM_CALL_BARRING_SUPPORTED"),	(xdrproc_t)xdr_u_char, sizeof( UInt8 ), NULL_capi2_proc_t, (xdrproc_t)xdr_u_char,0  },
        { (int) MS_LOCAL_CC_ELEM_AOC_SUPPORTED,_T("MS_LOCAL_CC_ELEM_AOC_SUPPORTED"),	(xdrproc_t)xdr_u_char, sizeof( UInt8 ), NULL_capi2_proc_t, (xdrproc_t)xdr_u_char,0  },
        { (int) MS_LOCAL_CC_ELEM_CUG_SUPPORTED,_T("MS_LOCAL_CC_ELEM_CUG_SUPPORTED"),	(xdrproc_t)xdr_u_char, sizeof( UInt8 ), NULL_capi2_proc_t, (xdrproc_t)xdr_u_char,0  },
		{ (int) MS_LOCAL_CC_ELEM_UMTS_WB_AMR,_T("MS_LOCAL_CC_ELEM_UMTS_WB_AMR"),	(xdrproc_t)xdr_u_char, sizeof( UInt8 ), NULL_capi2_proc_t, (xdrproc_t)xdr_u_char,0	},
        ...
        { (int)MS_LOCAL_SATK_ELEM_BIP_CTR,_T("MS_LOCAL_SATK_ELEM_BIP_CTR"),		                (xdrproc_t)xdr_u_char, sizeof( UInt8 ), NULL_capi2_proc_t, (xdrproc_t)xdr_u_char ,0 },
		...
		{ (int)MS_LOCAL_PHCTRL_ELEM_OPEN_NORMAL_MODE,_T("MS_LOCAL_PHCTRL_ELEM_OPEN_NORMAL_MODE"),			(xdrproc_t)xdr_u_char, sizeof( UInt8 ), NULL_capi2_proc_t, (xdrproc_t)xdr_u_char ,0 },
		{ (int)MS_LOCAL_PHCTRL_ELEM_FREQ_SEARCH_LIST,_T("MS_LOCAL_PHCTRL_ELEM_FREQ_SEARCH_LIST"),	(xdrproc_t)xdr_MSUarfcnList_t, sizeof(MSUarfcnList_t), NULL_capi2_proc_t, (xdrproc_t)xdr_MSUarfcnList_t,0},
		...
		{ (int)MS_LOCAL_AT_ELEM_QOS_CTRL,_T("MS_LOCAL_AT_ELEM_QOS_CTRL"),					(xdrproc_t)xdr_u_char, sizeof( UInt8 ), NULL_capi2_proc_t, (xdrproc_t)xdr_u_char,0 },
...
bool_t xdr_MS_GSMParam_t(void* xdrs, MS_GSMParam_t *param)
{
	...
	if(	_xdr_u_char(xdrs, &param->valid,"valid")  &&
		...
		xdr_u_int32_t(xdrs,(u_int32_t *)(void*) &param->l1_status)  &&
...
bool_t xdr_CAPI2_Oem_Payload_t(XDR* xdrs, CAPI2_Oem_Payload_t *param)
{
	XDR_LOG(xdrs,"CAPI2_Oem_Payload_t ")

	if(	xdr_u_int32_t(xdrs, &param->param) &&
		xdr_u_int32_t(xdrs, &param->len) )
	{
		return xdr_opaque(xdrs, (caddr_t)param->buffer, (param->len < MAX_OEM_BUFFER_SIZE)?param->len: MAX_OEM_BUFFER_SIZE ); 		
	}
	else
		return(FALSE);
}

bool_t xdr_WL_SocketFilterList_t(XDR* xdrs, WL_SocketFilterList_t *val)
{
	
	XDR_LOG(xdrs,"WL_SocketFilterList_t ")

	if(	_xdr_u_int16_t(xdrs, &val->filterType,"filterType") &&
		_xdr_u_char(xdrs, &val->bAutomaticRrcRelease,"bAutomaticRrcRelease") &&
		xdr_vector(xdrs,(char *) val->udpList, SOCKET_PACKETFILTER_UDP_MAX, sizeof(UInt16),(xdrproc_t) xdr_u_int16_t) &&
		xdr_vector(xdrs,(char *) val->tcpList, SOCKET_PACKETFILTER_TCP_MAX, sizeof(UInt16),(xdrproc_t) xdr_u_int16_t) )
	{
		return TRUE;
	}
