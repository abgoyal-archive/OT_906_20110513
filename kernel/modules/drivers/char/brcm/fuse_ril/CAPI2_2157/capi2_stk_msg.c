...
bool_t 
xdr_CAPI2_StkDataServReq_t(XDR* xdrs, CAPI2_StkDataServReq_t* req)
{
	XDR_LOG(xdrs,"CAPI2_StkDataServReq_t")

	return (xdr_pointer(xdrs, (char **)(void*) &req->req, sizeof(StkDataServReq_t), (xdrproc_t)xdr_StkDataServReq_t) );
}
...
xdr_StkOpenChanParam_t(XDR* xdrs, SATK_OPEN_CHAN_PARAM_t* stkOpenChanParam)
{
	...
	if( _xdr_Boolean(xdrs,  &stkOpenChanParam->immediate_establish,"immediate_establish") && 
        _xdr_Boolean(xdrs,  &stkOpenChanParam->auto_reconnect,"auto_reconnect") &&
        _xdr_Boolean(xdrs,  &stkOpenChanParam->transparent_mode,"transparent_mode") &&
        ...
        _xdr_Boolean(xdrs,  &stkOpenChanParam->static_ip_addr_exist,"static_ip_addr_exist") && 
        xdr_opaque(xdrs, (caddr_t)&stkOpenChanParam->static_ip_addr, STK_IPV4_ADDRESS_LEN) &&
        _xdr_Boolean(xdrs,  &stkOpenChanParam->dest_ip_addr_exist,"dest_ip_addr_exist") && 
       ...
       _xdr_u_int16_t(xdrs, &stkOpenChanParam->buffer_size,"buffer_size") &&
        ...
        _xdr_Boolean(xdrs,  &stkOpenChanParam->dataCompression,"dataCompression") &&
        _xdr_Boolean(xdrs,  &stkOpenChanParam->headerCompression,"headerCompression") &&
...
xdr_StkSendDataParam_t(XDR* xdrs, SATK_SEND_DATA_PARAM_t* stkSendDataParam)
{
	...
	if( xdr_bytes(xdrs, (char **)(void*)&stkSendDataParam->dataBuf, &len, 4096) &&
        ...
        _xdr_Boolean(xdrs,  &stkSendDataParam->send_data_immediately,"send_data_immediately") 
		)
		return(TRUE);
	else
		return(FALSE);
