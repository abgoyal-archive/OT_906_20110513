...
bool_t xdr_CAPI2_SYS_CellLock_Req_t(void* xdrs, CAPI2_SYS_CellLock_Req_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_SYS_CellLock_Req_t")
...
bool_t xdr_CAPI2_SIM_SubmitMulRecordEFileReq_Rsp_t(void* xdrs, CAPI2_SIM_SubmitMulRecordEFileReq_Rsp_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_SIM_SubmitMulRecordEFileReq_Rsp_t")

	 return xdr_pointer(xdrs, (char**)(void*)&rsp->val, sizeof( SIM_MUL_REC_DATA_t ), xdr_SIM_MUL_REC_DATA_t);
}
...
bool_t xdr_CAPI2_SYSPARM_GetImei_Req_t(void* xdrs, CAPI2_SYSPARM_GetImei_Req_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_SYSPARM_GetImei_Req_t")

	if(
		xdr_IMEI_TYPE_t(xdrs, &rsp->imei_type) &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_SIM_GetUsimCarrierMode_Rsp_t(void* xdrs, CAPI2_SIM_GetUsimCarrierMode_Rsp_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_SIM_GetUsimCarrierMode_Rsp_t")

	 return xdr_pointer(xdrs, (char**)(void*)&rsp->val, sizeof( SIM_GET_CARRIER_MODE_RSP_t ), xdr_SIM_GET_CARRIER_MODE_RSP_t);
}
...
bool_t xdr_CAPI2_AUDIO_DRV_SetAudioMode_Req_t(void* xdrs, CAPI2_AUDIO_DRV_SetAudioMode_Req_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_AUDIO_DRV_SetAudioMode_Req_t")

	if(
		xdr_AudioMode_t(xdrs, &rsp->mode) &&
		_xdr_UInt8(xdrs, &rsp->op,"op") &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_AUDIO_GetSettingsEx_Req_t(void* xdrs, CAPI2_AUDIO_GetSettingsEx_Req_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_AUDIO_GetSettingsEx_Req_t")

	if(
		_xdr_UInt8(xdrs, &rsp->audioMode,"audioMode") &&
		_xdr_UInt8(xdrs, &rsp->audioOp,"audioOp") &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_AUDIO_GetSettingsEx_Rsp_t(void* xdrs, CAPI2_AUDIO_GetSettingsEx_Rsp_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_AUDIO_GetSettingsEx_Rsp_t")
...
bool_t xdr_CAPI2_MS_LsaIdInd_Rsp_t(void* xdrs, CAPI2_MS_LsaIdInd_Rsp_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_MS_LsaIdInd_Rsp_t")

	 return xdr_pointer(xdrs, (char**)(void*)&rsp->val, sizeof( lsaIdentity_t ), xdr_lsaIdentity_t);
}

bool_t xdr_CAPI2_SIM_IsTestSIM_Rsp_t(void* xdrs, CAPI2_SIM_IsTestSIM_Rsp_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_SIM_IsTestSIM_Rsp_t")

	 return _xdr_Boolean(xdrs, &rsp->val,"val");
}

bool_t xdr_CAPI2_OEM_Set_Data_Req_t(void* xdrs, CAPI2_OEM_Set_Data_Req_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_OEM_Set_Data_Req_t")

	if(
		xdr_UInt32(xdrs, &rsp->type) &&
		xdr_pointer(xdrs, (char**)(void*)&rsp->payload,sizeof( CAPI2_Oem_Payload_t ), xdr_CAPI2_Oem_Payload_t) &&
	1)
		return TRUE;
	else
		return FALSE;
...
bool_t xdr_CAPI2_OEM_Set_Data_Rsp_t(void* xdrs, CAPI2_OEM_Set_Data_Rsp_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_OEM_Set_Data_Rsp_t")

	 return xdr_UInt32(xdrs, &rsp->val);
}

bool_t xdr_CAPI2_OEM_Get_Data_Req_t(void* xdrs, CAPI2_OEM_Get_Data_Req_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_OEM_Get_Data_Req_t")
...
bool_t xdr_CAPI2_OEM_Get_Data_Rsp_t(void* xdrs, CAPI2_OEM_Get_Data_Rsp_t *rsp)
{
	XDR_LOG(xdrs,"CAPI2_OEM_Get_Data_Rsp_t")

	 return xdr_CAPI2_Oem_Payload_t(xdrs, &rsp->val);
}
...
bool_t xdr_CAPI2_WL_PsSetFilterList_Req_t(void* xdrs, CAPI2_WL_PsSetFilterList_Req_t *rsp)
{
	...
	if(
		xdr_pointer(xdrs, (char**)(void*)&rsp->inClientInfoPtr,sizeof( ClientInfo_t ), xdr_ClientInfo_t) &&
		_xdr_UInt8(xdrs, &rsp->cid,"cid") &&
