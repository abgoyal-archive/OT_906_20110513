...
void GenGetPayloadInfo(void* dataBuf, MsgType_t msgType, void** ppBuf, UInt32* len)
{
	...
	{
		CAPI2_SIM_SubmitMulRecordEFileReq_Rsp_t* pVal = (CAPI2_SIM_SubmitMulRecordEFileReq_Rsp_t*)dataBuf;
		*ppBuf = (void*)(pVal->val);
		break;
	}
	...
	case MSG_SIM_GET_USIM_CARRIER_MODE_RSP:
	{
		CAPI2_SIM_GetUsimCarrierMode_Rsp_t* pVal = (CAPI2_SIM_GetUsimCarrierMode_Rsp_t*)dataBuf;
		*ppBuf = (void*)(pVal->val);
		break;
	}
	...
	case MSG_AUDIO_DRV_SetAudioMode_RSP:
	{
		*ppBuf = NULL; *len=0;
		break;
	}
	...
	case MSG_AUDIO_GET_SETTINGSEX_RSP:
	{
		CAPI2_AUDIO_GetSettingsEx_Rsp_t* pVal = (CAPI2_AUDIO_GetSettingsEx_Rsp_t*)dataBuf;
		*ppBuf = (void*)&(pVal->val);
		break;
	}
	...
	case MSG_LSA_ID_IND:
	{
		CAPI2_MS_LsaIdInd_Rsp_t* pVal = (CAPI2_MS_LsaIdInd_Rsp_t*)dataBuf;
		*ppBuf = (void*)(pVal->val);
		break;
	}
	case MSG_SIM_ISTESTSIM_RSP:
	{
		CAPI2_SIM_IsTestSIM_Rsp_t* pVal = (CAPI2_SIM_IsTestSIM_Rsp_t*)dataBuf;
		*ppBuf = (void*)&(pVal->val);
		break;
	}
	case MSG_MS_OEM_SET_DATA_RSP:
	{
		CAPI2_OEM_Set_Data_Rsp_t* pVal = (CAPI2_OEM_Set_Data_Rsp_t*)dataBuf;
		*ppBuf = (void*)&(pVal->val);
		break;
	}
	case MSG_MS_OEM_GET_DATA_RSP:
	{
		CAPI2_OEM_Get_Data_Rsp_t* pVal = (CAPI2_OEM_Get_Data_Rsp_t*)dataBuf;
		*ppBuf = (void*)&(pVal->val);
		break;
	}
