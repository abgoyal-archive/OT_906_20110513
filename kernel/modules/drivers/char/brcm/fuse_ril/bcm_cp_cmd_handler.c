...
void CAPI2_RTC_GetTime(UInt32 tid, UInt8 clientID, RTCTime_t *time)
{
    ...
    rtc_time.Sec   = (UInt8)tm.tm_sec;
    rtc_time.Min   = (UInt8)tm.tm_min;
    rtc_time.Hour  = (UInt8)tm.tm_hour;
    rtc_time.Day   = (UInt8)tm.tm_mday;
    rtc_time.Week  = (UInt8)tm.tm_wday;
    rtc_time.Month = (UInt8)(tm.tm_mon + 1);
    rtc_time.Year  = (UInt16)(tm.tm_year + 1900);
