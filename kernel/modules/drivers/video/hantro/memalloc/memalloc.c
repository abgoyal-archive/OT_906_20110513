...
#define MEMALLOC_SIZE   (1024*1024*6) //(SZ_4M)
...
unsigned int size_table_0[] = {
	...
	10, 10, 10, 10,			// For VT use case
	22, 22,  			// For VT use case
	24, 24, 24, 24, 		// For input buffer
	38, 38, 38, 38,			// For VT use case
	57, 57, 57, 57, 57, 57,		// HVGA 480*320*1.5
	113, 113, 114, 114, 114, 114,	// VGA 640*480*1.5
	150 				// VGA 640*480*2
};
#else
/*4MB in total*/
