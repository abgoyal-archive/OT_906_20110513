...
int	SwitchPCMOutputDevice(int dev);
...
ssize_t FMDirPlaySysfs_store(struct device *dev, struct device_attribute *attr,const char *buf, size_t count)
{
	...
	if(5!= sscanf(buf, "%d %d %d %d %d", &arg0, &arg1, &arg2, &arg3, &arg4))
	{
	...
	if(arg0 &&( (arg0!= sgFMDirectPlayValues[0])
		  		|| (arg1!= sgFMDirectPlayValues[1])
		  		|| (arg2!= sgFMDirectPlayValues[2])
		  		|| (arg3!= sgFMDirectPlayValues[3]) ) ) 		// enable path
	{

		
		DEBUG("\nFMDirPlaySysfs_store:Enable On_Off=%d OpMode=%d, samplerate=%d, channel=%d, volume=%d \n",  arg0, arg1, arg2, arg3, arg4);
		codecCfg.audioID = AUDIO_ID_IIS2DAC;
		codecCfg.sampleRate = arg2;
		codecCfg.monoStereo = arg3;
		HAL_AUDIO_Ctrl( ACTION_AUD_ConfigCodecParam, &codecCfg, NULL );

		pathCfg.audioID = AUDIO_ID_IIS2DAC;
		pathCfg.outputChnl = arg1;
		pathCfg.volumeLevel = arg4;
	...
	else if(arg0 && ( (arg4!= sgFMDirectPlayValues[4]) ) )
	{
		DEBUG("\nFMDirPlaySysfs_store:Volume On_Off=%d OpMode=%d, samplerate=%d, channel=%d, volume=%d \n",  arg0, arg1, arg2, arg3, arg4);
		pathCfg.audioID = AUDIO_ID_IIS2DAC;
		pathCfg.outputChnl = arg1;
		pathCfg.volumeLevel = arg4;
		HAL_AUDIO_Ctrl( ACTION_AUD_SetVolumeWithPath, &pathCfg, NULL );
	}
	else if ( (arg0!= sgFMDirectPlayValues[0]) && (!arg0) ) 
	{
		DEBUG("\nFMDirPlaySysfs_store:Disable On_Off=%d OpMode=%d, samplerate=%d, channel=%d, volume=%d \n",  arg0, arg1, arg2, arg3, arg4);	
		pathCfg.audioID = AUDIO_ID_IIS2DAC;
		pathCfg.outputChnl = arg1;
	...
	sgFMDirectPlayValues[0] = arg0;
	sgFMDirectPlayValues[1] = arg1; 
	sgFMDirectPlayValues[2] = arg2;
	sgFMDirectPlayValues[3] = arg3; 
	sgFMDirectPlayValues[4] = arg4;
	return count;
...
//						if(audioToneControlParam.outputChnl == AUDIO_CHNL_BT_MONO||audioToneControlParam.outputChnl==AUDIO_CHNL_BT_STEREO)
				...
				case BRCM_CTL_FMDirectPlayCtrl:
					...
					break;
				case BRCM_CTL_OUTPUT_DEVICE:
					SwitchPCMOutputDevice(sgBrcmCtrlVal[kcontrol->private_value]);
					break;
				default:
					break;
	}
...
static struct snd_kcontrol_new gpSndCtrls[] __devinitdata =
{
	...
	BRCM_MIXER_CTRL(gpstrCtrlName[BRCM_CTL_OUTPUT_DEVICE], 0, BRCM_CTL_OUTPUT_DEVICE),
};
