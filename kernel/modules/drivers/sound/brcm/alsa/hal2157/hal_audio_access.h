...
// enable this flag to support continuous voice recording after voice call disconnected 
// the basic idea is to keep ul path active after voice call if there is voice recording ongoing 
// still need some details about the correct user case and test cases 
#define ANDROID_FEATURE_VOICE_RECORDING 
