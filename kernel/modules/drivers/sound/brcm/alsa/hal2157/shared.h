...
#	define DSECT_PAGE29_RFSPI_SEC	NOT_INPAGE __attribute__( ( section( ".DSECT rf_spi_records"	) ) )
#	define DSECT_BTMIXER_P30		NOT_INPAGE __attribute__( ( section( ".DSECT btmixer_p30_sec"	) ) )
#	define DSECT_SHAREDMEM_P31		NOT_INPAGE __attribute__( ( section( ".DSECT pram_codec_in_p31_sec"	) ) )
#	undef EXTERN
...
#endif
#define PARTIAL_BER_SIZE	2		// Partil size of the BER tables
...
#define SHARED_INVALID_CELL	0x1f	// Invalid cell ID
...
#define		DSP_FEATURE_HR_VOICECODEC_DOWNLOADABLE
#define		DSP_2151B_DOWNLOADABLE_CODE
#define		DSP_2151B_CHIP_REV_B0
#define		DSP_FEATURE_OVERLAY_PATCH
#define		DSP_FEATURE_LOAD_E1_E2_PATCH
//#define		DSP_DYVE_TEST
#define		DSP_FEATURE_AHS_BER
#define		DSP_FEATURE_WIDE_FREQ_ACQ
#define		DSP_FEATURE_ENH_TRACKING_LOG
#define		DSP_FEATURE_ADAP_PARM
#define		DSP_FEATURE_PEAK_TIMING
#define		DSP_FEATURE_EPC			// Enable EPC channel coding feature in the DSP

#define CHIP_USED_IS_2153_E1	164733
#define CHIP_USED_IS_2153_E2	207227
#define		DSP_OVERLAY_PATCH_KEY	0xf001
#define		DSP_FEATURE_CONFIG_FQCR_FCWR
#define		DSP_FEATURE_ALPHA_VOICE
#define		DSP_FEATURE_KAPPA_VOICE
#define		DSP_FEATURE_WB_AUDIO_LOGGING
#define 	DSP_FEATURE_SAIC_BP_SLOT_OFFSET
//******************************************************************************
...
// ========================	   ====		====================================
	...
	COMMAND_POLYRINGER_STARTPLAY,	// 0x5d	( Polyringer Play )		**NOT USED ANYMORE**
	COMMAND_POLYRINGER_CANCELPLAY,	// 0x5e	( Polyringer Cancel )	**NOT USED ANYMORE**
	...
	COMMAND_SET_BTM_BUFFER_SIZE,			// 0x7D		**NOT USED ANYMORE**	
	...
	COMMAND_ENABLE_RF_RX_TEST,          // 0x88   (                     arg0                                                                          =                         rx                                       test                       flag                                       )                                          
	COMMAND_ENABLE_RF_TX_TEST,          // 0x89   (                     arg0                                                                          =                         tx                                       test                       flag                                       )                                          
	COMMAND_INIT_BIQUAD_FILTER_MEMORY,	// 0x8a  init biquad5 filter memory 
	COMMAND_DUAL_MIC_ENABLE,			// 0x8b	( arg0 = 0: Disable dual mic feature, 1: Enable dual mic feature )
 	COMMAND_MM_ENABLE,					// 0x8c (arg0 = 0; disable MM functions: wb_amr recorde/playback, !=0 Enable of MM functions according to wb_amr_ctrl switch)
 	COMMAND_CLEAR_VOIPMODE,				// 0x8d (arg0 = 0 to clear VOIPmode)
 	COMMAND_SMC_FCWR_CNFG_ENABLE,		// 0x8e	(arg0 = 1 to enable)
 	COMMAND_DUAL_SIM_TRACK,				// 0x8f	(arg0=Kd, arg1=delta_limit, arg2=delta_flag with zero means disabled)
 	COMMAND_MEM_DUMP,					// 0x90 (arg0/1/2: share mem page, reading addr, size)
 	COMMAND_SET_20MS_TRIGGER			// 0x91 (arg0=[1/0]=[enable/disable] 20ms status trigger to arm)
} Command_t;
...
// ========================	   ====		====================================
	...
	STATUS_POLYRINGER_PLAY_EVENT_DONE,	// 0x1C  ()	**NOT USED ANYMORE**
	STATUS_POLYRINGER_SW_FIFO_EMPTY,	// 0x1D  ()	**NOT USED ANYMORE**
	STATUS_POLYRINGER_DONEPLAY,			// 0x1E  ()	**NOT USED ANYMORE**
	STATUS_POLYRINGER_CANCELPLAY,		// 0x1F  ()	**NOT USED ANYMORE**
	...
	STATUS_CTM_ABORT_BY_PR,		// 0x28				**NOT USED ANYMORE**
	STATUS_PR_ABORT_BY_CTM,		// 0x29				**NOT USED ANYMORE**
	...
	STATUS_BTM_FRAME_DONE,				// 0x35		**NOT USED ANYMORE**
	...
	STATUS_CURR_MIN_STACK_PTR,			// 0x3D	Report the current minimum stack pointer
	STATUS_DYVE_BUFFER_READY,			// 0x3E	( Report DyVE buffer ready, arg0 means shared_DyVE_DL_buffer[160*arg0] for arm use, arg1=1 for 16K audio )
	STATUS_SHORT_FRAME,					// 0x3F	( Report the frame qbc is too short: arg0=qbc_next_frame, arg1=qbc_prev_adjust, arg2=next_next_rxmode|(next_next_cell<<8)|(next_next_slot<<13) )
 	STATUS_20MS_TRIGGER	,				// 0x40 (arg0=[1/0]=[enable/disable] 20ms status trigger to arm)
 	STATUS_DOWNLOADABLE_CODE_CHANGED,		// 0x41	arg0 previos PRAM loaded state, arg1 new PRAM loaded state
 	STATUS_DOWNLOADABLE_CODE_ERROR,		// 0x42	arg0 previos PRAM loaded state, arg1 new PRAM loaded state
	STATUS_NCELL_OTD_ADJUST,				// 0x43 ( Report the Ncell OTD adjustment by a frame, arg0=cell_id, arg1=adjustment(+1 or -1), otd)
	STATUS_PRAM_CODEC_DONE_CAPTURE		// 0x44	JustInTime WB Encoding
    ...
    STATUS_ERROR_E23,			0xec23		// Report ncell offset out of boundary warning (ncell_time_offset[ index ], qbc_adj, (flag<<8)|index).
    ...
    STATUS_ERROR_Da,			0xdeca		// Report 16K audio INT during 2G voice call
        STATUS_ERROR_P1,			0xEE0C		// Poly ringer FIFO test error
    STATUS_ERROR_DMA			0xEE0D		// DMA error
    STATUS_ERROR_MM_RECORD		0xEEE0		// MM error
    STATUS_ERROR_MM_PLAY		0xEEE1		// MM error
    STATUS_ERROR_MM_TEST		0xEEE2		// MM error
        */
} Status_t;
...
typedef enum
{
    ...
    EGPRS_SRBLOOP_ON,					// Enable EGPRS switched radio block symmetric loopback mode
	EGPRS_SRBLOOP_OFF,					// Disable EGPRS switched radio block loopback mode
...
{                                            
     UInt16 data3_L;              //lower  16bits-SPIAR dword 3 data
     UInt16 data3_H;              //higher 16bits-SPIAR dword 3 data
     UInt16 data2_L;              //lower  16bits-SPIAR dword 2 data
     UInt16 data2_H;              //higher 16bits-SPIAR dword 2 data
     UInt16 data1_L;              //lower  16bits-SPIAR dword 1 data
     UInt16 data1_H;              //higher 16bits-SPIAR dword 1 data
     UInt16 delay_L;              //lower 16bits of SPITSR or SPIRSR 
     UInt16 delay_H;              //higher 16bits of SPITSR or SPIRSR  
     UInt8  record_type;          //=1 for SPIRSR & =0 forSPITSR     
     UInt8  device_ID;        
} SPI_Records_t;  

typedef struct                  //Structure for dword0-2
{                                            
    UInt16 data_L[2];       //data_L[0] lower 16 bit's of dword 0 , data_L[1] lower 16 bit's of dword1 and etc     
    UInt16 data_H[2];       //data_H[0] upper 16 bit's of dword 0 
...
{                                            
     UInt16 data;            // data 
     UInt16 add;             // address of SPI Register 
} SPICTRL_Records_t;
...
#define PRAM_LOAD		0x0100


typedef struct
{
	UInt16 pram_no_code				: 1;	// no code loaded
	UInt16 pram_hr_vo				: 1;	// Half rate codec, default at boot
	UInt16 pram_ctm					: 1;	// Loaded CTM block
	UInt16 audio16k					: 1;	// loaded audio processig
	UInt16 aac_code					: 1;	// loaded audio processig
	UInt16 pram_mm_wb_amr			: 1;	// wb_amr record & Playback
	UInt16 pram_csd					: 1;	// csd
	UInt16 pram_delta				: 1;	// delta
	UInt16 pram_voip			  	: 1;	// voip pram
	UInt16 pram_wcdma_mst			: 1;	// MST for WCDMA
} PRAMCodeType_t;

typedef struct
{
	UInt16 dram_no_data 			: 1;	// no code loaded
	UInt16 dram_audio_proc			: 1;	// audio processig data page
	UInt16 dram_aac					: 1;	// aac data page
	UInt16 dram_mm_wb_amr			: 1;	// wb_amr data page
	UInt16 dram_voip				: 1;	// voip dram
} PRAMDataType_t;
...
{                    
	union
	{
		UInt16	frame_pcm[160];		//voip mode 1: PCM
...
//******************************* Additional tracking info for SCH **********************************
EXTERN UInt16 shared_SCH_track_snr_rxlev			DSECT_SHARED_SEC_UNPAGED;
EXTERN UInt16 shared_SCH_track_timing			  	DSECT_SHARED_SEC_UNPAGED;
EXTERN Int16 shared_SCH_track_freq_offset[2]  		DSECT_SHARED_SEC_UNPAGED;
EXTERN UInt16 shared_MM_wb_amr_mode[6]				DSECT_SHARED_SEC_UNPAGED;
EXTERN UInt16 shared_bluetooth_biquad5_enable		DSECT_SHARED_SEC_UNPAGED;
...
EXTERN UInt16 shared_CS4_modulation_flag			DSECT_DLCODEC_SEC_UNPAGED;
EXTERN UInt16 shared_null_pg_qbc_offset_th			DSECT_DLCODEC_SEC_UNPAGED;
EXTERN Int16 shared_null_pg_snr_th 					DSECT_DLCODEC_SEC_UNPAGED;
EXTERN Int16 shared_null_pg_qbc_offset[MAX_NUM_TEMPLATES] 	DSECT_DLCODEC_SEC_UNPAGED;


EXTERN UInt16 shared_amr_wb_encoder_output_vector	DSECT_DLCODEC_SEC_UNPAGED;
EXTERN UInt16 shared_amr_wb_decoder_input_vector	DSECT_DLCODEC_SEC_UNPAGED;
EXTERN UInt16 shared_interp_singl_fir_init_vector	DSECT_DLCODEC_SEC_UNPAGED;
EXTERN UInt16 shared_decim_singl_fir_init_vector	DSECT_DLCODEC_SEC_UNPAGED;
EXTERN UInt16 shared_interp_singl_fir_vector		DSECT_DLCODEC_SEC_UNPAGED;
EXTERN UInt16 shared_decim_singl_fir_vector			DSECT_DLCODEC_SEC_UNPAGED;
EXTERN UInt16 shared_amr_wb_vpu_src_vector		DSECT_DLCODEC_SEC_UNPAGED;

EXTERN UInt16	shared_spi_gpio_flag				DSECT_DLCODEC_SEC_UNPAGED;  // default 0 and will write gpio

EXTERN UInt16	shared_amr_wb_ecan_input_vector			DSECT_DLCODEC_SEC_UNPAGED;  
EXTERN UInt16	shared_amr_wb_audio_proc_vector		DSECT_DLCODEC_SEC_UNPAGED;  
EXTERN UInt16	shared_dual_mic_init_vector			DSECT_DLCODEC_SEC_UNPAGED;  


EXTERN UInt16 shared_PRAM_code_address_ind		DSECT_DLCODEC_SEC_UNPAGED;
EXTERN PRAMCodeType_t shared_PRAM_code_loaded		DSECT_DLCODEC_SEC_UNPAGED;
EXTERN PRAMCodeType_t shared_PRAM_code_loaded_set		DSECT_DLCODEC_SEC_UNPAGED;
EXTERN PRAMCodeType_t shared_PRAM_code_loaded_save		DSECT_DLCODEC_SEC_UNPAGED;
EXTERN PRAMDataType_t shared_DRAM_data_loaded			DSECT_DLCODEC_SEC_UNPAGED;
EXTERN PRAMDataType_t shared_DRAM_data_loaded_set		DSECT_DLCODEC_SEC_UNPAGED;
EXTERN PRAMDataType_t shared_DRAM_data_loaded_save		DSECT_DLCODEC_SEC_UNPAGED;
EXTERN UInt16 shared_dl_code_addr_hi[9] 				DSECT_DLCODEC_SEC_UNPAGED; // 
EXTERN UInt16 shared_dl_code_addr_lo[9] 				DSECT_DLCODEC_SEC_UNPAGED; // 
EXTERN UInt16 shared_dl_code_addr_len[9] 				DSECT_DLCODEC_SEC_UNPAGED; //  len is multiple of 16
EXTERN UInt16 shared_dl_code_addr_offset[9] 			DSECT_DLCODEC_SEC_UNPAGED; // offeset from 0xc000

EXTERN UInt16 shared_amr_wb_ecan_output_vector			DSECT_DLCODEC_SEC_UNPAGED;
EXTERN UInt16 shared_dual_mic_proc_vector				DSECT_DLCODEC_SEC_UNPAGED;

EXTERN VOIP_Buffer_t VOPI_DL_buf						DSECT_DLCODEC_SEC_UNPAGED;
EXTERN VOIP_Buffer_t VOPI_UL_buf						DSECT_DLCODEC_SEC_UNPAGED;
EXTERN UInt16 shared_dl_data_addr_hi[6] 				DSECT_DLCODEC_SEC_UNPAGED; // 
EXTERN UInt16 shared_dl_data_addr_lo[6] 				DSECT_DLCODEC_SEC_UNPAGED; // 
EXTERN UInt16 shared_dl_data_addr_len[6] 				DSECT_DLCODEC_SEC_UNPAGED; //  len is multiple of 16
EXTERN UInt16 shared_dl_data_addr_offset[6] 			DSECT_DLCODEC_SEC_UNPAGED; // offeset from 0xc000

EXTERN Int16 SAIC_BP_bit_shift[MAX_RX_SLOTS]			DSECT_DLCODEC_SEC_UNPAGED;
EXTERN Shared_BP_TrackData_t shared_BP_track_data[2]	DSECT_DLCODEC_SEC_UNPAGED;

EXTERN UInt16 shared_freq_acq_bin_index_ext				DSECT_DLCODEC_SEC_UNPAGED;
EXTERN UInt16 shared_8psk_equalizer_step_size			DSECT_DLCODEC_SEC_UNPAGED;

EXTERN Int16 shared_dummy_burst_midamble[16]			DSECT_DLCODEC_SEC_UNPAGED;
EXTERN Int16 shared_flag_dummy_burst		 			DSECT_DLCODEC_SEC_UNPAGED;

EXTERN Int16 shared_HT_time_jitter_thr_lo	 			DSECT_DLCODEC_SEC_UNPAGED;
EXTERN Int16 shared_HT_time_jitter_thr_hi	 			DSECT_DLCODEC_SEC_UNPAGED;

EXTERN PRAMCodeType_t shared_PRAM_code_load_request		DSECT_DLCODEC_SEC_UNPAGED;
EXTERN PRAMCodeType_t shared_PRAM_code_load_pending		DSECT_DLCODEC_SEC_UNPAGED;
...
EXTERN UInt16 shared_freq_acq_bin_index				DSECT_SHARED_SEC_PAGE0;	// Shortest frame size (depends on tune_time)
EXTERN UInt16 shared_freq_est_pair_dist[4]			DSECT_SHARED_SEC_PAGE0;	// Shortest frame size (depends on tune_time)
EXTERN UInt16 shared_freq_est_pair_num[4]			DSECT_SHARED_SEC_PAGE0;	// Shortest frame size (depends on tune_time)
EXTERN UInt16 shared_freq_est_pair_scale[4]			DSECT_SHARED_SEC_PAGE0;	// Shortest frame size (depends on tune_time)
EXTERN UInt16 shared_freq_est_coef[4]				DSECT_SHARED_SEC_PAGE0;	// Shortest frame size (depends on tune_time)
...
EXTERN UInt16 shared_fcwr_value						DSECT_SHARED_SEC_PAGE0;
...
EXTERN UInt16 shared_new_serv_band					DSECT_SHARED_SEC_PAGE0;
...
EXTERN UInt16 	shared_BTM_total_page 						DSECT_SHARED_SEC_PAGE0;		// Keep it now since arm code still refers it **NOT USED ANYMORE**
...
EXTERN UInt16  shared_AHS_sid_update_reencode_bound_h	DSECT_SHARED_SEC_PAGE0;
...
EXTERN Int16 shared_saic_bp_adap_ht3_rxlv_thr	DSECT_PAGE1_SHARED_SEC;	// 23  SAIC new adapation HT3 rxlv threshould
EXTERN Int16 shared_saic_bp_adap_ht3_snr_thr 	DSECT_PAGE1_SHARED_SEC;	// 240 SAIC new adapation HT3 SNR threshould
EXTERN Int16 shared_saic_bp_adap_ht3_timing_thr	DSECT_PAGE1_SHARED_SEC;	// 300 SAIC new adapation timing jitter threshould
...
EXTERN Int16 shared_unused_page1[ 14 ]			DSECT_PAGE1_SHARED_SEC;	
...
EXTERN UInt16 shared_tch_dlink_info[7]			DSECT_PAGE1_ECHO_SHARED;
...
EXTERN Int16 shared_ec_tmp_buf[320]					DSECT_PAGE1_ECHO_SHARED;
...
EXTERN UInt16 shared_ul_subband_noise_energies_from_arm[32]	 	DSECT_PAGE1_ECHO_SHARED;	//16 band subband energy, Linear for 1st 10ms frame
EXTERN UInt16 shared_ns_forced_init_etot_th					 	DSECT_PAGE1_ECHO_SHARED;	//etot threshold for NS forced adap
EXTERN UInt16 shared_ns_forced_update_noise_est_flag		 	DSECT_PAGE1_ECHO_SHARED;	//flag to force an update of the NS noise estimate
EXTERN UInt16 shared_ul_subband_noise_energies_to_arm[32]	 	DSECT_PAGE1_ECHO_SHARED;	//16 band subband noise energies, Linear
//Biquad5
EXTERN UInt16	shared_bluetooth_biquad5_dl_enable					DSECT_PAGE1_ECHO_SHARED;	//[1/0]=[enable/disable]
EXTERN UInt16	shared_bluetooth_biquad5_ul_enable					DSECT_PAGE1_ECHO_SHARED;	//[1/0]=[enable/disable]
EXTERN UInt16	shared_bluetooth_biquad5_dl_gain				DSECT_PAGE1_ECHO_SHARED;	//Normalisation gain, unsigned, 0x4000=unit_gain
EXTERN UInt16	shared_bluetooth_biquad5_ul_gain				DSECT_PAGE1_ECHO_SHARED;	//Normalisation gain, unsigned, 0x4000=unit_gain
EXTERN UInt16	shared_bluetooth_biquad5_dl_outshift		   	DSECT_PAGE1_ECHO_SHARED;	//
EXTERN UInt16	shared_bluetooth_biquad5_ul_outshift		   	DSECT_PAGE1_ECHO_SHARED;	//
EXTERN Int16	shared_bluetooth_biquad5_dl_coefs[25]			DSECT_PAGE1_ECHO_SHARED;
EXTERN Int16	shared_bluetooth_biquad5_ul_coefs[25]			DSECT_PAGE1_ECHO_SHARED;
EXTERN Int32	shared_bluetooth_biquad5_dl_states[25]			DSECT_PAGE1_ECHO_SHARED;
EXTERN Int32	shared_bluetooth_biquad5_ul_states[25]			DSECT_PAGE1_ECHO_SHARED;
EXTERN UInt16	shared_alpha_voice_gain_scale					DSECT_PAGE1_ECHO_SHARED;	//Provide the means to scale the NS gain
EXTERN Int16	shared_ns_gain_dB_prev[16]						DSECT_PAGE1_ECHO_SHARED;
EXTERN UInt16	shared_alpha_voice_enable						DSECT_PAGE1_ECHO_SHARED;
EXTERN Int16	shared_alpha_voice_pitch_delay_buf[5]			DSECT_PAGE1_ECHO_SHARED;	//pitch delay line
EXTERN Int16	shared_alpha_voice_pitch_hangover_ptr			DSECT_PAGE1_ECHO_SHARED;
EXTERN Int16	shared_alpha_voice_max_supp[16]					DSECT_PAGE1_ECHO_SHARED;
EXTERN Int16	shared_alpha_voice_snr_thresh[16]				DSECT_PAGE1_ECHO_SHARED;
EXTERN Int16	shared_alpha_voice_sw_max_min_th				DSECT_PAGE1_ECHO_SHARED;

EXTERN Int16 shared_freqloop_offset[ DSP_SYNC_LIST_SIZE ]			DSECT_PAGE1_ECHO_SHARED;	
EXTERN Int16 shared_idev_thld									DSECT_PAGE1_ECHO_SHARED;	// NS background noise estimate adaptation performance fine tuning
EXTERN Int16 shared_iupdate_thld 								DSECT_PAGE1_ECHO_SHARED;	// NS background noise estimate adaptation performance fine tuning
EXTERN Int16 shared_ihyster_cnt_thld 							DSECT_PAGE1_ECHO_SHARED;	// NS background noise estimate adaptation performance fine tuning
EXTERN Int16	shared_alpha_voice_med_filt_enable				DSECT_PAGE1_ECHO_SHARED;
EXTERN UInt16	shared_asp_dl_gain[5]							DSECT_PAGE1_ECHO_SHARED;
EXTERN UInt16	shared_alpha_voice_forced_noise_update_flag[16]	DSECT_PAGE1_ECHO_SHARED;	//flag to force an update of the NS noise estimate subband by subband
EXTERN UInt16	shared_alpha_voice_mean_diff_th					DSECT_PAGE1_ECHO_SHARED;
EXTERN UInt16	shared_alpha_voice_mean_pt_th					DSECT_PAGE1_ECHO_SHARED;
EXTERN UInt16	shared_alpha_voice_curr_pt_th					DSECT_PAGE1_ECHO_SHARED;
EXTERN UInt16	shared_alpha_voice_etot_th						DSECT_PAGE1_ECHO_SHARED;
EXTERN UInt16	shared_alpha_voice_ns_alpha						DSECT_PAGE1_ECHO_SHARED;
EXTERN UInt16	shared_alpha_voice_ns_alpha_minus_1				DSECT_PAGE1_ECHO_SHARED;
EXTERN UInt16	shared_subband_dl_analysis_gain					DSECT_PAGE1_ECHO_SHARED;
EXTERN UInt16 shared_dual_mic_subband_energy_dB_0[16]			DSECT_PAGE1_ECHO_SHARED;	//16 band subband energy, dB
EXTERN UInt16 shared_dual_mic_subband_energy_dB_1[16]			DSECT_PAGE1_ECHO_SHARED;	//16 band subband energy, dB

EXTERN UInt16 shared_exp_4_1_sel_flag							DSECT_PAGE1_ECHO_SHARED;    //Flag to select 4:1 expander
EXTERN UInt16 shared_clr_aud_buf_flag							DSECT_PAGE1_ECHO_SHARED;    //Flag to clear audio buffers at speech enc input
																							//if there is mis-match in the sample rates used
																							//at the o/p of ECAN and NS.

//WB NS/NLP shared variables
EXTERN UInt16 shared_subband_nlp_noise_margin_wb[24]			DSECT_PAGE1_ECHO_SHARED;	//MARGIN below the noise floor used when calculating NLP loss
EXTERN UInt16 shared_subband_nlp_UL_margin_wb[24]				DSECT_PAGE1_ECHO_SHARED;	//MARGIN below the UL estimated signal level used when calculating NLP loss
EXTERN Int16 shared_noise_max_supp_dB_wb[24]					DSECT_PAGE1_ECHO_SHARED;	//Maximum amount of suppression by band in dBQ5
EXTERN UInt16 shared_subband_nlp_erl_erle_adj_wb[24]			DSECT_PAGE1_ECHO_SHARED;	//24 band subband erl_erle adjustment in dB 
EXTERN UInt16 shared_subband_nlp_distortion_adj_wb[24]			DSECT_PAGE1_ECHO_SHARED;	//24 band subband erl_erle adjustment in dB based purely on DL distortion estimation
EXTERN UInt16 shared_dl_subband_energy_dB_0_wb[24]				DSECT_PAGE1_ECHO_SHARED;	//24 band subband energy, dB
EXTERN UInt16 shared_dl_subband_energy_dB_1_wb[24]				DSECT_PAGE1_ECHO_SHARED;	//24 band subband energy, dB
EXTERN UInt16 shared_ul_subband_energy_dB_0_wb[24]				DSECT_PAGE1_ECHO_SHARED;	//24 band subband energy, dB
EXTERN UInt16 shared_ul_subband_energy_dB_1_wb[24]				DSECT_PAGE1_ECHO_SHARED;	//24 band subband energy, dB
EXTERN Int16 shared_subband_nlp_gains_wb[24]					DSECT_PAGE1_ECHO_SHARED;	// Pass the final g_nlp[] gains to the ARM for extra logging capability

EXTERN Int16 shared_comp_output_power[5]						DSECT_PAGE1_ECHO_SHARED;	// Used to store energy measured after all DL audio processing
EXTERN Int16 shared_subband_final_ns_gains[16]					DSECT_PAGE1_ECHO_SHARED;	// Pass the final ns gains(sGammaTot) to the ARM.
EXTERN UInt16 shared_subband_erl_erle_wb[24]					DSECT_PAGE1_ECHO_SHARED;	// 24 band subband erl and erle in dB   (for WB NS/NLP)
...
// Dual-SIM related data.  NOTE: This should be placed in the same page as STATUS QUEUE
EXTERN UInt16 shared_ncell_adjust[ DSP_SYNC_LIST_SIZE/4 ]	DSECT_PAGE5_SHARED_SEC;

EXTERN UInt16 shared_ctrlchnl_dlink_info[4]					DSECT_PAGE5_SHARED_SEC;
EXTERN Int16 shared_dsp_capture16KPCM[320]					DSECT_PAGE5_SHARED_SEC;
EXTERN Int16 shared_uC_16KPCM[320]							DSECT_PAGE5_SHARED_SEC;	
...
EXTERN UInt16 shared_dbg_xram_BT_UL_filt_coefs[1]			DSECT_RF_CONTROL_P6;
...
EXTERN Audio_Logging_Buf_t shared_audio_stream_0[2]		DSECT_RF_CONTROL_P6;	// 8/16KHz 20ms double buffer of Audio
EXTERN Audio_Logging_Buf_t shared_audio_stream_1[2]		DSECT_RF_CONTROL_P6;	// 8/16KHz 20ms double buffer of Audio
...
{
#endif	// MSP
//Dedicated for dynamic loading of the DSP Patch code ...
EXTERN UInt16 shared_PRAM_PatchBuffer[4096]		DSECT_PRAM_CODEC_IN_P24;
#ifdef MSP
} PAGE24_SharedMem_t;
#endif	// MSP
...
{
#endif	// MSP
EXTERN Audio_Logging_Buf_t shared_audio_stream_2[2]		DSECT_PRAM_CODEC_IN_P25;	// 8/16KHz 20ms double buffer of Audio
EXTERN Audio_Logging_Buf_t shared_audio_stream_3[2]		DSECT_PRAM_CODEC_IN_P25;	// 8/16KHz 20ms double buffer of Audio
//shared by all downloadable codec: AAC, MP3 ...
EXTERN UInt16 shared_DyVE_enable_flag				DSECT_PRAM_CODEC_IN_P25;
EXTERN UInt16 shared_DyVE_DL_buffer_index			DSECT_PRAM_CODEC_IN_P25;
EXTERN Int16 shared_DyVE_DL_buffer[640]				DSECT_PRAM_CODEC_IN_P25;
EXTERN Int16 shared_DyVE_UL_buffer[640]				DSECT_PRAM_CODEC_IN_P25;
EXTERN UInt16 shared_page10_unused[246]			DSECT_PRAM_CODEC_IN_P25;
#ifdef MSP
} PAGE25_SharedMem_t;
#endif	// MSP
...
#endif	// MSP
//Dedicated for dynamic loading of the DSP Patch code ...
EXTERN UInt16 shared_PRAM_PatchBuffer2[4096]		DSECT_PRAM_CODEC_IN_P26;
#ifdef MSP
} PAGE26_SharedMem_t;
#endif	// MSP
...
{
#endif	// MSP
// SPI RF Interface variables, not enough space to put in page 6 with the other rf control variables
EXTERN SPI_Records_t		shared_spiar_records[96]		DSECT_PAGE29_RFSPI_SEC;	//  
EXTERN SPI_DS_dword_t		shared_spiar_dword[4]			DSECT_PAGE29_RFSPI_SEC;       
EXTERN SPICTRL_Records_t	shared_spictrl_records[10]      DSECT_PAGE29_RFSPI_SEC;  

EXTERN UInt16				shared_gpio_gpspi				DSECT_PAGE29_RFSPI_SEC;  // default 0 and will write gpio
EXTERN UInt16				shared_spird_hw_lo				DSECT_PAGE29_RFSPI_SEC;  
EXTERN UInt16				shared_spird_hw_hi				DSECT_PAGE29_RFSPI_SEC;  
EXTERN UInt16				shared_spipage					DSECT_PAGE29_RFSPI_SEC;  
EXTERN UInt16				shared_spisr_lo					DSECT_PAGE29_RFSPI_SEC;  
EXTERN UInt16				shared_spisr_hi					DSECT_PAGE29_RFSPI_SEC;  
EXTERN UInt16				shared_spird_sw_lo				DSECT_PAGE29_RFSPI_SEC;  
EXTERN UInt16				shared_spird_sw_hi				DSECT_PAGE29_RFSPI_SEC;  


EXTERN UInt16				shared_spictrl_records_update_cnt		DSECT_PAGE29_RFSPI_SEC;  
EXTERN UInt16				shared_spi_rec_rx_start					DSECT_PAGE29_RFSPI_SEC;  
EXTERN UInt16				shared_spi_rec_rx_end_tx_start			DSECT_PAGE29_RFSPI_SEC;  
EXTERN UInt16				shared_spi_rec_tx_end_mon_start			DSECT_PAGE29_RFSPI_SEC;  
...
EXTERN UInt16 shared_page30_unused[AUDIO_SIZE_PER_PAGE]		DSECT_BTMIXER_P30;
#ifdef MSP
} PAGE30_SharedMem_t;
#endif	// MSP
...
#define	LIN_PCM_FRAME_SIZE				160		// Size of an uncompressed linear PCM speech frame at 8KHz
#define WB_LIN_PCM_FRAME_SIZE			320		// Size of an uncompressed linear PCM speech frame at 16KHz
#define	AMR_FRAME_SIZE					16		// Maximum size of any Amr speech recording/playback frame 
#define	AMR_WB_FRAME_SIZE				32		// Maximum size of any Amr wb speech recording/playback frame 
...
typedef enum
{
	...
	SPEECH_MODE_AHS,
	SPEECH_MODE_AMR_WB,
	SPEECH_MODE_VOIP_FR = 0x2000,
	SPEECH_MODE_VOIP_AMR_NB = 0x3000
} SpeechMode_t;
...
{ 
	...
	AMR_MRDTX	= 8,	//not used
    AMR_N_MODES	= 9,    /* number of (SPC) modes, not used */
...
EXTERN VR_Frame_AMR_WB_t DL_MainAMR_buf    			   		DSECT_VP_SHARED_SEC;
        // Downlink received primary AMR data buf during GSM idle (WCDMA voice call)
EXTERN VR_Frame_AMR_WB_t UL_MainAMR_buf    			   		DSECT_VP_SHARED_SEC;
