        ...
        case AUDIO_DRIVER_START:
            {
                ...
                result_code = csl_audio_render_configure ( aud_drv->sample_rate, 
						                      ...
						                      num_blocks,
						                      block_size,
						                      (OSDAL_DMA_CALLBACK) AUDIO_DRIVER_RenderDmaCallback,
                                              aud_drv->stream_id);
        ...
        case AUDIO_DRIVER_START:
            {
                ...
                result_code = csl_audio_capture_configure ( aud_drv->sample_rate, 
						                      ...
						                      num_blocks,
						                      block_size,
						                      (OSDAL_DMA_CALLBACK) AUDIO_DRIVER_CaptureDmaCallback,
                                              aud_drv->stream_id);
        ...
        case AUDIO_DRIVER_START:
            {
                ...
                result_code = dspif_VPU_record_start ( VOCAPTURE_RECORD_UL,
								aud_drv->sample_rate,
								speech_mode, 
...
static void AUDIO_DRIVER_CaptureVoiceCallback(UInt32 buf_index)
{
    ...
    if( split >  0)
	{
        ...
        //recv_size = dspif_VPU_record_read_PCM ( pdest_buf+dest_index, end_size, buf_index, aud_drv->speech_mode,aud_drv->num_frames);
		dest_index = 0;
	}
	recv_size = dspif_VPU_record_read_PCM ( pdest_buf+dest_index, num_bytes_to_copy-end_size, buf_index, aud_drv->speech_mode,aud_drv->num_frames);
    
    dest_index += (num_bytes_to_copy-end_size) ;
