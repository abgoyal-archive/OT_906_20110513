...
static TIDChanOfPlaybackDev	sgTableIDChannelOfDev[] = {
	{AUDIO_DRIVER_PLAY_AUDIO, AUDIO_HW_AUDIO_OUT, AUDCTRL_SPK_HANDSET},//spk normal
	{AUDIO_DRIVER_PLAY_RINGER, AUDIO_HW_AUDIO_OUT, AUDCTRL_SPK_HANDSET},//spk ringtone
	{AUDIO_DRIVER_PLAY_AUDIO, AUDIO_HW_AUDIO_OUT, AUDCTRL_SPK_HANDSET},//earpiece  normal
	{AUDIO_DRIVER_PLAY_RINGER, AUDIO_HW_AUDIO_OUT, AUDCTRL_SPK_HANDSET},//earpiece ringtone
	{AUDIO_DRIVER_PLAY_AUDIO, AUDIO_HW_AUDIO_OUT, AUDCTRL_SPK_HEADSET},//headset  normal
	{AUDIO_DRIVER_PLAY_RINGER, AUDIO_HW_AUDIO_OUT, AUDCTRL_SPK_HEADSET},//headset ringtone
	{AUDIO_DRIVER_PLAY_BT, AUDIO_HW_AUDIO_OUT, AUDCTRL_SPK_BTM},//bt headset  normal
	{AUDIO_DRIVER_PLAY_BT, AUDIO_HW_AUDIO_OUT, AUDCTRL_SPK_BTM}//bt headset ringtone
};

static TIDChanOfCaptureDev	sgTableIDChannelOfCaptDev[] = {
...
static TIDChanOfVoiceCallDev	sgTableIDChannelOfVoiceCallDev[] = {
	{AUDIO_HW_VOICE_IN, AUDCTRL_MIC_MAIN, AUDIO_HW_VOICE_OUT,AUDCTRL_SPK_HANDSET},//incall speaker
    {AUDIO_HW_VOICE_IN, AUDCTRL_MIC_MAIN, AUDIO_HW_VOICE_OUT,AUDCTRL_SPK_HANDSET},//incall earpiece
    {AUDIO_HW_VOICE_IN, AUDCTRL_MIC_MAIN, AUDIO_HW_VOICE_OUT,AUDCTRL_SPK_HEADSET},//incall headset
    {AUDIO_HW_VOICE_IN, AUDCTRL_MIC_MAIN, AUDIO_HW_VOICE_OUT,AUDCTRL_SPK_BTM},//incall bt
};
...
/***FIXE: Change the below numbers */
#define	PCM_MAX_PLAYBACK_BUF_BYTES		(60*1024)
#define	PCM_MIN_PLAYBACK_PERIOD_BYTES		(12*1024)
#define	PCM_MAX_PLAYBACK_PERIOD_BYTES		(12*1024)

#define	PCM_MAX_CAPTURE_BUF_BYTES       (60*1024)
#define	PCM_MIN_CAPTURE_PERIOD_BYTES    (320 * 2)
#define	PCM_MAX_CAPTURE_PERIOD_BYTES    (PCM_MIN_CAPTURE_PERIOD_BYTES * 4)
...
//        DEBUG("\nEnable telephony \n");  
 //       AUDCTRL_EnableTelephony(AUDIO_HW_VOICE_IN,AUDIO_HW_VOICE_OUT,sgTableIDChannelOfVoiceCallDev[substream->number-VOICE_CALL_SUB_DEVICE].mic,sgTableIDChannelOfVoiceCallDev[substream->number-VOICE_CALL_SUB_DEVICE].speaker);
    ...
    drv_handle = AUDIO_DRIVER_Open(sgTableIDChannelOfDev[substream->number].drv_type);
...
static int PcmPlaybackClose(struct snd_pcm_substream * substream)
{
    ...
    AUDCTRL_DisablePlay(AUDIO_HW_NONE,
                        sgTableIDChannelOfDev[substream->number].hw_id,
                        sgTableIDChannelOfDev[substream->number].speaker
                    );
		...
		case SNDRV_PCM_TRIGGER_START:
            {
                ...
                AUDCTRL_EnableRecord(sgTableIDChannelOfCaptDev[substream->number].hw_id,
				                     AUDIO_HW_NONE,
                                     sgTableIDChannelOfCaptDev[substream->number].mic,
				                     runtime->channels,
                                     runtime->rate);
		...
		case SNDRV_PCM_TRIGGER_STOP:
            {
                ...
                AUDCTRL_DisableRecord(sgTableIDChannelOfCaptDev[substream->number].hw_id,
                                      AUDIO_HW_NONE,
                                      sgTableIDChannelOfCaptDev[substream->number].mic);
